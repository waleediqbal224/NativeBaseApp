...
import {Actionsheet, useDisclose, Box, Skeleton} from 'native-base';
  ...
  return (
    <View style={styles.container}>
      <View style={{margin: 10}}>
        ...
        <Skeleton.Text isLoaded={loaded} lines={1} alignSelf={'center'}  w={150} >
      ...
      <View style={styles.profileContainer}>
        <View style={{alignItems: 'center'}}>
            ...
            endColor="warmGray.300" h={30} w={100} rounded={'full'} isLoaded={loaded} >
        ...
        <View style={{alignItems: 'center', padding: 20}}>
            <Skeleton borderColor="coolGray.200"
            endColor="warmGray.300" h={10} w={300} rounded={'full'} isLoaded={loaded} >
        ...
        <Skeleton borderColor="coolGray.200"
            endColor="warmGray.300" h={5} w={200} rounded={'full'} isLoaded={loaded} >
        <View
          style={{
            flexDirection: 'row',
            width: 250,
          ...
          <Image source={Images.LinkedInLogo} style={{height: 28, width: 28}} />
          <Text style={{color: '#0274B3', marginLeft: 20, fontWeight: '700'}}>
